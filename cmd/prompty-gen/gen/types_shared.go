...
// Contains: type PromptID, PromptCatalog interface, constructor, typed render methods, Descriptor, AllPromptIDs.
func GenerateSharedTypes(pkgName string, specs []*PromptSpec) (*jen.File, error) {
	...
	catalogFields := append(
		[]jen.Code{jen.Id("registry").Qual("github.com/skosovsky/prompty", "DescribingRegistry")},
		structFields...,
	)
	...
	f.Func().Id("NewPromptCatalog").Params(
		jen.Id("r").Qual("github.com/skosovsky/prompty", "DescribingRegistry"),
