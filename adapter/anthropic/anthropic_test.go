...
func TestUsageFromAnthropic_MapsBreakdownFields(t *testing.T) {
	...
	got := usageFromAnthropic(anthropic.Usage{
		InputTokens:              40,
		OutputTokens:             9,
	...
	assert.Equal(t, prompty.Usage{
		...
		CompletionTokens:          9,
		TotalTokens:               66,
		PromptTokensCached:        11,
		PromptTokensCacheCreation: 6,
	}, got)
}
